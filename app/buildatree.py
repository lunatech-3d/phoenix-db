...
def build_family_tree(person_id, indent="", is_last_child=False):
    ...
    if person_info:
        ...
        for index, child in enumerate(children, start=1):
            ...
            build_family_tree(child_id, indent + "   │", is_last_child)
...
if result:
    ...
    # Print the family tree for the person and their descendants
    tree_output = ""
    tree_output += "Family Tree:\n"
    tree_output += "-------------\n"
    build_family_tree(id_)
